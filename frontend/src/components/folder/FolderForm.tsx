...
const FolderForm: React.FC<FolderFormProps> = ({folder, onSubmit, onCancel, loading = false}) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <label htmlFor="folderName" className="block text-md font-medium text-neutral-700 mb-2">
                    Name
                </label>
                <input
                    id="folderName"
            ...
            <div>
                <label htmlFor="folderDescription" className="block text-md font-medium text-neutral-700 mb-2">
                    Description
                </label>
                <textarea
